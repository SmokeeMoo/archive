...
<div id="<?= 'biolink_block_id_' . $data->link->biolink_block_id ?>" data-biolink-block-id="<?= $data->link->biolink_block_id ?>" class="col-12 my-2">
    ...
    <div class="cardslider">
        ...
        <?php if($item->enable): ?>
        <div class="cardddd" style="display:block;background: <?= $data->link->settings->background_color ?>;border-radius: 10px; color: <?= $data->link->settings->text_color ?>; line-height: 1.1; padding: 20px 25px;    margin: 0 5px;"><div style="font-weight:bold; margin: 10px 0 15px; font-size: 120%"><?= $item->title ?></div>
            <p><?= $item->content ?></p>
        </div>
        <?php endif ?>
        <?php endforeach ?>
