        ...
        if(!empty($_POST)) {
            ...
            if($_POST['is_bulk'] && $_POST['type'] == 'text') {
                ...
                foreach($data_rows as $data_row) {
                    ...
                    if(isset($_POST['qr_code_logo'])) $request_files['qr_code_logo'] = $_FILES['qr_code_logo']['tmp_name'];
                    if(isset($_POST['qr_code_background'])) $request_files['qr_code_background'] = $_FILES['qr_code_background']['tmp_name'];
                    if(isset($_POST['qr_code_foreground'])) $request_files['qr_code_foreground'] = $_FILES['qr_code_foreground']['tmp_name'];
