...
$tmpoll_block = \Altum\Plugin::is_active('tmpoll-block') && file_exists(\Altum\Plugin::get('tmpoll-block')->path . 'tmpoll_block.php') ? include \Altum\Plugin::get('tmpoll-block')->path . 'tmpoll_block.php' : [];
$tmquiz_block = \Altum\Plugin::is_active('tmquiz-block') && file_exists(\Altum\Plugin::get('tmquiz-block')->path . 'tmquiz_block.php') ? include \Altum\Plugin::get('tmquiz-block')->path . 'tmquiz_block.php' : [];
$tmswipe_block = \Altum\Plugin::is_active('tmswipe-block') && file_exists(\Altum\Plugin::get('tmswipe-block')->path . 'tmswipe_block.php') ? include \Altum\Plugin::get('tmswipe-block')->path . 'tmswipe_block.php' : [];
$tmyookassa_block = \Altum\Plugin::is_active('tmyookassa-block') && file_exists(\Altum\Plugin::get('tmyookassa-block')->path . 'tmyookassa_block.php') ? include \Altum\Plugin::get('tmyookassa-block')->path . 'tmyookassa_block.php' : [];
$tmmessengers_block = \Altum\Plugin::is_active('tmmessengers-block') && file_exists(\Altum\Plugin::get('tmmessengers-block')->path . 'tmmessengers_block.php') ? include \Altum\Plugin::get('tmmessengers-block')->path . 'tmmessengers_block.php' : [];
$tmribbon_block = \Altum\Plugin::is_active('tmribbon-block') && file_exists(\Altum\Plugin::get('tmribbon-block')->path . 'tmribbon_block.php') ? include \Altum\Plugin::get('tmribbon-block')->path . 'tmribbon_block.php' : [];
$tmappointments_block = \Altum\Plugin::is_active('tmappointments-block') && file_exists(\Altum\Plugin::get('tmappointments-block')->path . 'tmappointments_block.php') ? include \Altum\Plugin::get('tmappointments-block')->path . 'tmappointments_block.php' : [];
