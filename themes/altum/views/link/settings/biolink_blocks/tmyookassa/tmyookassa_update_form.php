...
<form name="update_biolink_" method="post" role="form">
    ...
    <input type="hidden" name="block_type" value="tmyookassa" />
    ...
    <!--<div class="form-group custom-control custom-switch">
        ...
        <label class="custom-control-label" for="<?= 'link_open_in_new_tab_' . $row->biolink_block_id ?>"><?= l('create_biolink_link_modal.input.open_in_new_tab') ?></label>
                    ...
                    <div class="form-group">
                    <label for="<?= 'tmyookassa_shopid_block_' . $row->biolink_block_id ?>"><i class="fas fa-fw fa-shop fa-sm text-muted mr-1"></i> <?= l('create_biolink_tmyookassa_modal.shopid_block') ?></label>
                    <input id="<?= 'tmyookassa_shopid_block_' . $row->biolink_block_id ?>" type="text" name="shopid_block" class="form-control" maxlength="2048"  value="<?= $row->settings->shopid_block ?>" placeholder="<?= l('create_biolink_tmyookassa_modal.shopid_block_placeholder') ?>" />
                </div>
                
                    <div class="form-group">
                    <label for="<?= 'tmyookassa_secretkey_block_' . $row->biolink_block_id ?>"><i class="fas fa-fw fa-key fa-sm text-muted mr-1"></i> <?= l('create_biolink_tmyookassa_modal.secretkey_block') ?></label>
                    <input id="<?= 'tmyookassa_secretkey_block_' . $row->biolink_block_id ?>" type="text" name="secretkey_block" class="form-control" maxlength="2048"  value="<?= $row->settings->secretkey_block ?>" placeholder="<?= l('create_biolink_tmyookassa_modal.secretkey_block_placeholder') ?>" />
                </div>
                
                    <div class="form-group">
                    <label for="<?= 'tmyookassa_amount_block_' . $row->biolink_block_id ?>"><i class="fas fa-fw fa-sack-dollar fa-sm text-muted mr-1"></i> <?= l('create_biolink_tmyookassa_modal.amount_block') ?></label>
                    <input id="<?= 'tmyookassa_amount_block_' . $row->biolink_block_id ?>" type="number" name="amount_block" class="form-control" maxlength="2048"  value="<?= $row->settings->amount_block ?>" placeholder="<?= l('create_biolink_tmyookassa_modal.amount_block_placeholder') ?>" />
                </div>
                
                    <div class="form-group">
                    <label for="<?= 'tmyookassa_currency_block_' . $row->biolink_block_id ?>"><i class="fas fa-fw fa-dollar-sign fa-sm text-muted mr-1"></i> <?= l('create_biolink_tmyookassa_modal.currency_block') ?></label>
                    <input id="<?= 'tmyookassa_currency_block_' . $row->biolink_block_id ?>" type="text" name="currency_block" class="form-control" maxlength="2048"  value="<?= $row->settings->currency_block ?>" placeholder="<?= l('create_biolink_tmyookassa_modal.currency_block_placeholder') ?>" />
                </div>
                
                    <div class="form-group">
                    <label for="<?= 'tmyookassa_paymentdescription_block_' . $row->biolink_block_id ?>"><i class="fas fa-fw fa-signature fa-sm text-muted mr-1"></i> <?= l('create_biolink_tmyookassa_modal.paymentdescription_block') ?></label>
                    <input id="<?= 'tmyookassa_paymentdescription_block_' . $row->biolink_block_id ?>" type="text" name="paymentdescription_block" class="form-control" maxlength="2048"  value="<?= $row->settings->paymentdescription_block ?>" placeholder="<?= l('create_biolink_tmyookassa_modal.paymentdescription_block_placeholder') ?>" />
                </div>
                
                    <div class="form-group">
                    <label for="<?= 'tmyookassa_successpayment_block_' . $row->biolink_block_id ?>"><i class="fas fa-fw fa-square-check fa-sm text-muted mr-1"></i> <?= l('create_biolink_tmyookassa_modal.successpayment_block') ?></label>
                    <input id="<?= 'tmyookassa_successpayment_block_' . $row->biolink_block_id ?>" type="text" name="successpayment_block" class="form-control" maxlength="2048"  value="<?= $row->settings->successpayment_block ?>" placeholder="<?= l('create_biolink_tmyookassa_modal.successpayment_block_placeholder') ?>" />
                </div>
