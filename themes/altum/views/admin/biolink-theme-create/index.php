    ...
    <div class="card-body">
        ...
        <form action="" method="post" role="form" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input id="biolink_block_description_color" type="color" name="biolink_block_description_color" class="form-control" value="<?= $data->values['biolink_block_description_color'] ?>" required="required" />
            </div>
