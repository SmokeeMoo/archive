            ...
            <form action="" method="post" role="form">
                ...
                <div class="form-group">
                    ...
                    <select id="processor" name="processor" class="custom-select <?= \Altum\Alerts::has_field_errors('processor') ? 'is-invalid' : null ?>">
                        <?php foreach(['paypal', 'stripe', 'crypto_com', 'razorpay', 'paystack', 'mollie', 'yookassa'] as $processor): ?>
                ...
                <div>
                    ...
                    <div class="form-group" data-processor="yookassa">
                        <label for="shop_id"><?= l('payment_processors.input.yookassa.shop_id') ?></label>
                        <input id="shop_id" type="text" name="shop_id" class="form-control" value="<?= $data->payment_processor->settings->shop_id ?? null ?>" required="required" />
                    </div>
                    
                    <div class="form-group" data-processor="yookassa">
                        <label for="secretkey"><?= l('payment_processors.input.yookassa.secretkey') ?></label>
                        <input id="secretkey" type="text" name="secretkey" class="form-control" value="<?= $data->payment_processor->settings->secretkey ?? null ?>" required="required" />
                    </div>
                    
                    
                    <div data-processor="yookassa">
                        <button class="btn btn-block btn-gray-200 my-4" type="button" data-toggle="collapse" data-target="#yookassa_instructions_container" aria-expanded="false" aria-controls="yookassa_instructions_container">
                            <i class="fas fa-fw fa-circle-question fa-sm mr-1"></i> <?= l('payment_processors.input.instructions') ?>
                        </button>
                        
                        <div class="collapse" id="yookassa_instructions_container">
                            <ol>
                                <li><?= l('payment_processors.input.yookassa.instructions_1') ?></li>
                                <li><?= l('payment_processors.input.yookassa.instructions_2') ?></li>
                                <li><?= sprintf(l('payment_processors.input.yookassa.instructions_3'), SITE_URL . 'l/guest-payment-webhook?processor=yookassa&payment_processor_id=' . $data->payment_processor->payment_processor_id) ?></li>
                                <li><?= l('payment_processors.input.yookassa.instructions_4') ?></li>
                            </ol>
                        </div>
                    </div>
                </div>
